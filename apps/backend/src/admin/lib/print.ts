...
/**
 * THE PRINTED ORDER DOCUMENTS — invoice, packing slip, the combined A4, and the A6 parcel slip.
 *
 * Templates are plain HTML strings opened in a new window: self-contained, no print CSS fighting
 * the admin's own styles, and what you see in the preview is exactly what the printer gets.
 */
const esc = (s: unknown) =>
