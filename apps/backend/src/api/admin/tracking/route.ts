...
type TrackingService = {
  ...
  // Generated by MedusaService as update(data, sharedContext) — the id goes INSIDE data.
  updateTrackingSettings: (data: { id: string } & Record<string, unknown>) => Promise<any>
}
...
export const POST = async (
  ...
  await svc.updateTrackingSettings({ id: row.id, ...update })
